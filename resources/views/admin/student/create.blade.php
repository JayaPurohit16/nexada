        ...
        <div class="card-body p-24">
            <form action="{{ route('admin.student.store') }}" method="POST" id="studentForm"
                ...
                <ul class="nav border-gradient-tab nav-pills d-inline-flex" id="myTab" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                        <button class="nav-link d-flex align-items-center px-24" id="cardDetails-tab" data-bs-toggle="tab"
                            data-bs-target="#cardDetails" type="button" role="tab" aria-controls="CardDetails"
