    ...
    <div class="dashboard-main-body">
        ...
        <div class="card basic-data-table">
            <div class="card-header d-flex flex-row align-items-center justify-content-between">
                ...
                <a href="{{ route('admin.student.create') }}" class="btn btn-sm btn-primary-600"><i class="ri-add-line"></i>
                    Add Student</a>
            </div>
            <div class="card-body">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#dataTable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('admin.student.getStudent') }}",
                    type: "POST",
                    data: function(data) {
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            let editUrl =
                                '{{ route('admin.student.edit', ['id' => '__id__']) }}'
                                .replace('__id__', data);
                            let deleteUrl =
                                '{{ route('admin.student.destroy', ['id' => '__id__']) }}'
                                .replace('__id__', data);
