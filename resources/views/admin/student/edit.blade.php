    ...
    <div class="dashboard-main-body">
        ...
        <div class="card h-100 p-0 radius-12">
            <div class="card-body p-24">
                <form action="{{ route('admin.student.update') }}" method="POST" id="studentForm" enctype="multipart/form-data">
                    @csrf
                            ...
                            <div class="row gy-4">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control radius-8 @error('first_name') is-invalid @enderror" name="first_name" id="first_name"
                                        placeholder="First Name" maxlength="100" value="{{ $student->userInfo->first_name ?? '' }}">
                                    @error('first_name')
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control radius-8 @error('second_name') is-invalid @enderror" name="second_name" id="second_name"
                                        placeholder="Second Name" maxlength="100" value="{{ $student->userInfo->second_name ?? '' }}">
                                    @error('second_name')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="mb-20">
                                        ...
                                        <input type="email" class="form-control radius-8 @error('email') is-invalid @enderror" name="email"
                                            id="email" placeholder="Email address" maxlength="100" value="{{ $student->userInfo->email ?? '' }}">
                                            @error('email')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control radius-8 @error('phone') is-invalid @enderror" name="phone" id="phone"
                                        ...
                                        onkeyup="this.value=this.value.replace(/[^0-9]/g, '')" value="{{ $student->userInfo->phone ?? '' }}">
                                    @error('phone')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                    ...
                                    <select name="primary_instrument" id="primary_instrument" class="form-control">
                                        @if(isset($instruments))
                                            @foreach ($instruments as $instrument)
                                                <option value="{{ $instrument->id }}" @if ($instrument->id == $student->primary_instrument) selected @endif>{{ $instrument->name }}</option>
                                            @endforeach
                                        @endif
                                    </select>
                                        ...
                                        <select name="location_id" id="location_id" class="form-control">
                                            @if (isset($locations))
                                                @foreach ($locations as $location)
                                                    <option value="{{ $location->id }}" @if ($location->id == $student->location_id) selected @endif>{{ $location->name }}</option>
                                                @endforeach
                                            @endif
                                    </select>
                                    @error('location_id')
                                        ...
                                        <select name="plan" id="plan" class="form-control">
                                            @if (isset($subscriptionTypes))
                                                @foreach ($subscriptionTypes as $subscriptionType)
                                                    <option value="{{ $subscriptionType->id }}" @if ($subscriptionType->id == $student->plan) selected @endif>
                            ...
                            <div class="row gy-4">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control radius-8 @error('parent_first_name') is-invalid @enderror" name="parent_first_name" id="parent_first_name"
                                        placeholder="First Name" maxlength="100" value="{{ $student->parentInfo->userInfo->first_name ?? '' }}">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control radius-8 @error('parent_second_name') is-invalid @enderror" name="parent_second_name" id="parent_second_name"
                                        placeholder="Second Name" maxlength="100" value="{{ $student->parentInfo->userInfo->second_name ?? '' }}">
                                ...
                                <div class="col-sm-6">
                                    <div class="mb-20">
                                        ...
                                        <input type="parent_email" class="form-control radius-8 @error('parent_email') is-invalid @enderror" name="parent_email"
                                            id="parent_email" placeholder="Email address" maxlength="100" value="{{ $student->parentInfo->userInfo->email ?? '' }}">
                                        @error('parent_email')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control radius-8 @error('parent_phone') is-invalid @enderror" name="parent_phone" id="parent_phone"
                                        placeholder="Phone" minlength="10" maxlength="10" onkeypress='return event.charCode >= 48 && event.charCode <= 57'
                                        onkeyup="this.value=this.value.replace(/[^0-9]/g, '')" value="{{ $student->parentInfo->userInfo->phone ?? '' }}">
                                    @error('parent_phone')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row gy-4">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control radius-8 @error('card_number') is-invalid @enderror" name="card_number" id="card_number"
                                        placeholder="Card Number" value="{{ $cardDetails->card_number }}" minlength="16" maxlength="16" onkeypress='return event.charCode >= 48 && event.charCode <= 57'
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="expiry_month" id="expiry_month" class="form-control">
                                        ...
                                        <option value="1" @if ($cardDetails->expiry_month == "1") selected @endif>January</option>
                                        <option value="2" @if ($cardDetails->expiry_month == "2") selected @endif>February</option>
                                        <option value="3" @if ($cardDetails->expiry_month == "3") selected @endif>March</option>
                                        <option value="4" @if ($cardDetails->expiry_month == "4") selected @endif>April</option>
                                        <option value="5" @if ($cardDetails->expiry_month == "5") selected @endif>May</option>
                                        <option value="6" @if ($cardDetails->expiry_month == "6") selected @endif>June</option>
                                        <option value="7" @if ($cardDetails->expiry_month == "7") selected @endif>July</option>
                                        <option value="8" @if ($cardDetails->expiry_month == "8") selected @endif>August</option>
                                        <option value="9" @if ($cardDetails->expiry_month == "9") selected @endif>September</option>
                                        <option value="10" @if ($cardDetails->expiry_month == "10") selected @endif>October</option>
                                        <option value="11" @if ($cardDetails->expiry_month == "11") selected @endif>November</option>
                                        <option value="12" @if ($cardDetails->expiry_month == "12") selected @endif>December</option>
                                    </select>
                                    @error('expiry_month')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="expiry_year" id="expiry_year" class="form-control">
                                        ...
                                        <option value="2024" @if ($cardDetails->expiry_year == "2024") selected @endif>2024</option>
                                        <option value="2025" @if ($cardDetails->expiry_year == "2025") selected @endif>2025</option>
                                        <option value="2026" @if ($cardDetails->expiry_year == "2026") selected @endif>2026</option>
                                        <option value="2027" @if ($cardDetails->expiry_year == "2027") selected @endif>2027</option>
                                        <option value="2028" @if ($cardDetails->expiry_year == "2028") selected @endif>2028</option>
                                        <option value="2029" @if ($cardDetails->expiry_year == "2029") selected @endif>2029</option>
                                        <option value="2030" @if ($cardDetails->expiry_year == "2030") selected @endif>2030</option>
                                        <option value="2031" @if ($cardDetails->expiry_year == "2031") selected @endif>2031</option>
                                        <option value="2032" @if ($cardDetails->expiry_year == "2032") selected @endif>2032</option>
                                        <option value="2033" @if ($cardDetails->expiry_year == "2033") selected @endif>2033</option>
                                        <option value="2034" @if ($cardDetails->expiry_year == "2034") selected @endif>2034</option>
                                        <option value="2035" @if ($cardDetails->expiry_year == "2035") selected @endif>2035</option>
                                        <option value="2036" @if ($cardDetails->expiry_year == "2036") selected @endif>2036</option>
                                        <option value="2037" @if ($cardDetails->expiry_year == "2037") selected @endif>2037</option>
                                        <option value="2038" @if ($cardDetails->expiry_year == "2038") selected @endif>2038</option>
                                        <option value="2039" @if ($cardDetails->expiry_year == "2039") selected @endif>2039</option>
                                        <option value="2040" @if ($cardDetails->expiry_year == "2040") selected @endif>2040</option>
                                    </select>
                                    @error('expiry_year')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-sm-6">
                                    <div class="mb-20">
                                        ...
                                        <input type="cvv" class="form-control radius-8 @error('cvv') is-invalid @enderror" name="cvv"
                                            id="cvv" placeholder="CVV" value="{{ $cardDetails->cvv }}" minlength="3" maxlength="3" onkeypress='return event.charCode >= 48 && event.charCode <= 57'
                                            onkeyup="this.value=this.value.replace(/[^0-9]/g, '')">
                                        @error('cvv')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
