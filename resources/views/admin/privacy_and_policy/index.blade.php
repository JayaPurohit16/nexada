    ...
    <div class="dashboard-main-body">
        ...
        <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
            ...
            <ul class="d-flex align-items-center gap-2">
                ...
                <li>-</li>
                <li class="fw-medium">Privacy & Policy</li>
            </ul>
        </div>

        <div class="card basic-data-table radius-12 overflow-hidden">
            <form action="{{ route('admin.privacyAndPolicy.store') }}" method="POST" id="privacyAndPolicyForm">
                @csrf
...
@section('script-js')
    ...
    <script>
        ...
        $('#privacyAndPolicyForm').on('submit', function(e) {
