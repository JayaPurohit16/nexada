            ...
            <div class="user-grid-card position-relative border radius-16 overflow-hidden bg-base h-100">
                ...
                <div class="pb-24 ms-16 mb-24 me-16  mt--100">
                    <div class="text-center border border-top-0 border-start-0 border-end-0">
                        <a href="{{ (!empty($user->profile_image) && file_exists($user->profile_image)) ? asset($user->profile_image) : asset('assets/images/user-grid/user-grid-img13.png') }}"
                            class="glightbox border br-white border-width-2-px w-200-px h-200-px rounded-circle object-fit-cover"
                            data-glightbox="avatar-1">
                            <img src="{{ (!empty($user->profile_image) && file_exists($user->profile_image)) ? asset($user->profile_image) : asset('assets/images/user-grid/user-grid-img13.png') }}"
                                alt="image" />
                        </a>
                        <!-- <img src="{{ (!empty($user->profile_image) && file_exists($user->profile_image)) ? asset($user->profile_image) : asset('assets/images/user-grid/user-grid-img13.png') }}"
                            alt=""
                    ...
                    <div class="tab-content" id="pills-tabContent">
                        <div class="tab-pane fade show active" id="pills-edit-profile" role="tabpanel"
                            ...
                            <form action="{{route('admin.profile.update')}}" method="POST" id="profileForm"
                                ...
                                <div class="mb-24 mt-16">
                                    <div class="avatar-upload">
                                        ...
                                        <div class="avatar-preview">
                                            <div id="imagePreview"
                                                style="background-image: url('{{ (!empty($user->profile_image) && file_exists($user->profile_image)) ? asset($user->profile_image) : asset('assets/images/user-grid/user-grid-img13.png') }}');">
                                            </div>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="mb-20">
                                            ...
                                            <input type="text"
                                                ...
                                                value="{{ $user->second_name ?? '' }}" placeholder="First Name"
                                                maxlength="100">
                                            @error('second_name')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                ...
                                <div
                                    class="d-flex align-items-center justify-content-sm-end justify-content-center gap-sm-3 gap-1">
                                    <button type="button"
