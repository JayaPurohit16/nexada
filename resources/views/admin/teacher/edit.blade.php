    ...
    <div class="dashboard-main-body">
        ...
        <div class="card h-100 p-0 radius-12">
            <div class="card-body p-24">
                <form action="{{ route('admin.teacher.update') }}" method="POST" id="teacherForm" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row gy-4">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control radius-8 @error('first_name') is-invalid @enderror" name="first_name" id="first_name"
                                placeholder="First Name" maxlength="100" value="{{ $teacher->userInfo->first_name ?? '' }}">
                            @error('first_name')
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control radius-8 @error('second_name') is-invalid @enderror" name="second_name" id="second_name"
                                placeholder="Second Name" maxlength="100" value="{{ $teacher->userInfo->second_name ?? '' }}">
                            @error('second_name')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-sm-6">
                            <div class="mb-20">
                                ...
                                <input type="email" class="form-control radius-8 @error('email') is-invalid @enderror" name="email"
                                    id="email" placeholder="Email address" maxlength="100" value="{{ $teacher->userInfo->email ?? '' }}">
                                    @error('email')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control radius-8 @error('phone') is-invalid @enderror" name="phone" id="phone"
                                ...
                                onkeyup="this.value=this.value.replace(/[^0-9]/g, '')" value="{{ $teacher->userInfo->phone ?? '' }}">
                            @error('phone')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        {{-- <div class="col-md-6">
                            ...
                            <div class="avatar-upload">
                                ...
                                <div class="avatar-preview">
                                    <div id="imagePreview" style="background-image: url('{{ (!empty($teacher->userInfo->profile_image)) ? asset($teacher->userInfo->profile_image) : asset('assets/images/user-grid/user-grid-img13.png') }}');"> 
                                    </div>
