...
<div class="dashboard-main-body">
    ...
    <div class="card h-100 p-0 radius-12">
        <div class="card-body p-24">
            <form action="{{ route('admin.teacher.store') }}" method="POST" id="teacherForm"
                enctype="multipart/form-data">
                @csrf
                <div class="row gy-4">
                    <div class="col-lg-4 col-md-6">
                        <label for="first_name" class="form-label fw-semibold text-primary-light text-sm">First
                    ...
                    <div class="col-lg-4 col-md-6">
                        <label for="second_name" class="form-label fw-semibold text-primary-light text-sm">Second
                            Name <span class="text-danger-600">*</span></label>
                        <input type="text" class="form-control radius-8 @error('second_name') is-invalid @enderror"
                            name="second_name" id="second_name" placeholder="Second Name"
                            value="{{ old('second_name') }}" maxlength="100">
                        @error('second_name')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="mb-20">
                            <label for="email" class="form-label fw-semibold text-primary-light text-sm">Email
                    ...
                    <div class="col-lg-4 col-md-6 mt-0">
                        <label for="phone" class="form-label fw-semibold text-primary-light text-sm">Contact Number
                            <span class="text-danger-600">*</span></label>
                        <input type="text" class="form-control radius-8 @error('phone') is-invalid @enderror"
                            name="phone" id="phone" placeholder="Contact Number" value="{{ old('phone') }}"
                    ...
                    {{-- <div class="col-md-6">
                        ...
                        <div class="avatar-upload">
                            ...
                            <div class="avatar-preview">
                                <div id="imagePreview"
                                    style="background-image: url('{{ asset('assets/images/user-grid/user-grid-img13.png') }}');">
                                </div>
                    ...
                    <div class="col-lg-4 col-md-6 mt-0">
                        <label for="location_id" class="form-label fw-semibold text-primary-light text-sm">Location
                            <span class="text-danger-600">*</span></label>
                        <select name="location_id" id="location_id" class="form-control select-form-control">
                            @if (isset($locations))
                    ...
                    <div class="col-lg-4 col-md-6 mt-0">
                        <label for="instrument_id"
                            class="form-label fw-semibold text-primary-light text-sm">Instrument/Instruments Can
                            Teach <span class="text-danger-600">*</span></label>
                        <select name="instrument_id[]" id="instrument_id" class="form-control select2 select-instrument"
                            multiple="multiple">
                    ...
                    <div class="col-lg-4 col-md-6 mt-0">
                        <label for="imageUpload" class="form-label fw-semibold text-secondary-light text-md">Profile
                            Picture <span class="text-danger-600"></span>
                            <span class="text-secondary-light fw-normal"></span></label>
                        <div class="d-flex gap-2">
                            <input type="file" name="image"
                                class="form-control profile-pic radius-8 @error('image') is-invalid @enderror"
