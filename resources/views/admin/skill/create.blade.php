                ...
                <div class="row gy-4">
                    <div class="col-lg-4 col-md-6">
                        ...
                        <input type="text" class="form-control radius-8 @error('name') is-invalid @enderror" name="name"
                            id="name" placeholder="Name" value="{{ old('name') }}" maxlength="100">
                        @error('name')
                    ...
                    <div class="col-lg-4 col-md-6">
                        ...
                        <select name="instrument_id" id="instrument_id" class="form-control select-form-control">
                    ...
                    <div class="col-lg-4 col-md-6">
                        ...
                        <input type="text" class="form-control radius-8 @error('category') is-invalid @enderror"
                            name="category" id="category" placeholder="Category" value="{{ old('category') }}"
                            maxlength="100">
                        @error('category')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="d-flex gap-2">
                            <div id="supporting-docs-container" class="flex-grow-1">
                                <div class="input-group mb-3">
                                    <input type="file" class="form-control radius-8" name="supporting_docs[]"
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="d-flex gap-2">
                            <div id="tutorial-videos-container" class="flex-grow-1">
                                <div class="input-group mb-3">
                                    <input type="file" class="form-control radius-8" name="tutorial_videos[]"
                                        accept=".mp4, .avi, .mov, .mkv," multiple>
                                    {{-- <button type="button" class="btn btn-outline-danger remove-btn">Remove</button>
                                    --}}
                                </div>
                            </div>
