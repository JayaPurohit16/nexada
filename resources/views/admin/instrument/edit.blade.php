...
<div class="dashboard-main-body">
    ...
    <div class="card h-100 p-0 radius-12">
        <div class="card-body p-24">
            <form action="{{ route('admin.instrument.update') }}" method="POST" id="instrumentForm"
                ...
                <div class="row gy-4">
                    <div class="col-lg-4 col-md-6">
                        ...
                        <input type="text" class="form-control radius-8 @error('name') is-invalid @enderror" name="name"
                            id="name" placeholder="Display name" maxlength="100" value="{{ $instrument->name }}">
                        @error('name')
                    ...
                    <div class="col-lg-4 col-md-6">
                        ...
                        <input type="text" class="form-control radius-8 @error('tag') is-invalid @enderror" name="tag"
                            id="tag" placeholder="tag" maxlength="100" value="{{ $instrument->tag }}">
                        @error('tag')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                            ...
                            <div class="avatar-upload">
                                <div class="avatar-preview style-two">
                                    <div id="previewImage1"
                                        style="background-image: url('{{ (!empty($instrument->image) && file_exists($instrument->image)) ? asset($instrument->image) : asset('assets/images/instrument-image.jpg') }}');">
                                    </div>
                                </div>
                            </div>
                        </div>
