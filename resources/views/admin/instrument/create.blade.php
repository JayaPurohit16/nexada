    ...
    <div class="dashboard-main-body">
        ...
        <div class="card h-100 p-0 radius-12">
            <div class="card-body p-24">
                <form action="{{ route('admin.instrument.store') }}" method="POST" id="instrumentForm" enctype="multipart/form-data">
                    @csrf
                    <div class="row gy-4">
                        <div class="col-md-6">
                            <label for="name"
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="avatar-upload mt-16">
                                <div class="avatar-preview style-two">
                                    <div id="previewImage1" style="background-image: url('{{ asset('assets/images/instrument-image.jpg') }}');"></div>
                                </div>
                            </div>
                        </div>
