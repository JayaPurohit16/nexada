        ...
        $('#dataTable').DataTable({
            ...
            // },
            {
                ...
                render: function (data, type, row) {
                    if (data !== null) {
                        // return `<img src="{{ asset('${data}') }}" class="img-thumbnail" alt="Image">`;
                        return `<a href="{{ asset('${data}') }}" class="glightbox" data-glightbox="avatar-1" style="padding: .25rem; max-width: 50px; height: auto">
                                    <img src="{{ asset('${data}') }}" alt="image" />
                                </a>`;
                    } else {
                        // return `<img src="{{ asset('assets/images/instrument-image.jpg') }}" class="img-thumbnail" alt="Image">`;
                        return `<a href="{{ asset('assets/images/instrument-image.jpg') }}" class="glightbox" data-glightbox="avatar-1">
                                    <img src="{{ asset('assets/images/instrument-image.jpg') }}" alt="image" />
                                </a>`;
                    }
                },
                orderable: false,
