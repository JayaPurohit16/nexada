    ...
    <div class="dashboard-main-body">
        ...
        <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
            ...
            <ul class="d-flex align-items-center gap-2">
                ...
                <li>-</li>
                <li class="fw-medium">Location</li>
            </ul>
        </div>
        ...
        <div class="card basic-data-table">
            <div class="card-header d-flex flex-row align-items-center justify-content-between">
                ...
                <a href="{{ route('admin.location.create') }}" class="btn btn-sm btn-primary-600"><i
                    class="ri-add-line"></i>
                Add Location</a>
            </div>
            <div class="card-body">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#dataTable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('admin.location.getLocation') }}",
                    type: "POST",
                    data: function(data) {
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            let editUrl =
                                '{{ route('admin.location.edit', ['id' => '__id__']) }}'
                                .replace('__id__', data);
                            let deleteUrl =
                                '{{ route('admin.location.destroy', ['id' => '__id__']) }}'
                                .replace('__id__', data);
