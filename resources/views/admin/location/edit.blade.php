...
@section('content')
    <div class="dashboard-main-body">
        <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
            <h6 class="fw-semibold mb-0">Edit Location</h6>
        ...
        <div class="card h-100 p-0 radius-12">
            <div class="card-body p-24">
                <form action="{{ route('admin.location.update') }}" method="POST" id="locationForm" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row gy-4">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control radius-8 @error('name') is-invalid @enderror" name="name" id="name"
                                placeholder="Location" maxlength="100" value="{{ $location->name ?? '' }}">
                            @error('name')
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control radius-8 @error('phone') is-invalid @enderror" name="phone" id="phone"
                                ...
                                onkeyup="this.value=this.value.replace(/[^0-9]/g, '')" value="{{ $location->phone ?? '' }}">
                            @error('phone')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control radius-8 @error('api_key') is-invalid @enderror" name="api_key" id="api_key"
                                placeholder="API Key" maxlength="150" value="{{ $location->api_key ?? '' }}">
                            @error('api_key')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control radius-8 @error('api_secret_key') is-invalid @enderror" name="api_secret_key" id="api_secret_key"
                                placeholder="Secret Key" maxlength="150" value="{{ $location->api_secret_key ?? '' }}">
                        ...
                        <div class="col-md-6">
                            ...
                            <textarea type="text" class="form-control radius-8 @error('address') is-invalid @enderror" name="address" id="address"
                                placeholder="Address" maxlength="200">{{ $location->address }}</textarea>
                            @error('address')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
