                ...
                <div class="row gy-4">
                    <div class="col-md-6">
                        ...
                        <input type="number" class="form-control radius-8 @error('price') is-invalid @enderror"
                            name="price" id="price" value="{{ $registrationFee->price ?? '' }}"
                            placeholder="Registration Fee" maxlength="8">
                        @error('price')
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            if (data !== null) {
                                return `<img src="{{ asset('${data}') }}" alt="Image" style="padding: .25rem;
                                        max-width: 100px;
                                        height: auto">`;
                            } else {
                                return `<img src="{{ asset('assets/images/subscription-icon.png') }}" alt="Image" style="padding: .25rem;
                                        max-width: 100px;
                                        height: auto">`;
                            }
                        },
