    ...
    <div class="dashboard-main-body">
        ...
        <div class="card h-100 p-0 radius-12">
            <div class="card-body p-24">
                <form action="{{ route('admin.subscription.update') }}" method="POST" id="subscriptionForm" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="id" value="{{ $subscription->id }}">
                    <div class="row gy-4">
                        <div class="col-md-6">
                            <label for="name"
                                class="form-label fw-semibold text-primary-light text-sm mb-8">Subscription <span class="text-danger-600">*</span></label>
                            <input type="text" class="form-control radius-8 @error('name') is-invalid @enderror" name="name" id="name"
                                placeholder="Subscription" maxlength="100" value="{{ $subscription->name ?? '' }}">
                            @error('name')
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" class="form-control radius-8 @error('lesson_per_week') is-invalid @enderror" name="lesson_per_week" id="lesson_per_week"
                                ...
                                onkeyup="this.value=this.value.replace(/[^0-9]/g, '')" value="{{ $subscription->lesson_per_week ?? '0' }}" min="0" max="100">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" class="form-control radius-8 @error('time') is-invalid @enderror" name="time" id="time"
                                ...
                                onkeyup="this.value=this.value.replace(/[^0-9]/g, '')" value="{{ $subscription->time ?? '0' }}" min="0" max="100">
                            @error('time')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                                    ...
                                    <div class="col-md-12 pricing-group">
                                        ...
                                        <div class="row gy-4">
                                            <div class="col-md-3">
                                                ...
                                                onkeyup="this.value=this.value.replace(/[^0-9]/g, '')" value="{{ $subscriptionType->amount ?? '' }}" min="0" max="100000">
                                                @error('price.*')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                onkeyup="this.value=this.value.replace(/[^0-9]/g, '')" value="{{ $subscriptionType->discount ?? '' }}" min="0" max="100">
                                                @error('discount.*')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" class="form-control radius-8 @error('amount_of_free_lessons') is-invalid @enderror" name="amount_of_free_lessons" id="amount_of_free_lessons"
                                ...
                                onkeyup="this.value=this.value.replace(/[^0-9]/g, '')" value="{{ $subscription->amount_of_free_lessons ?? '0' }}" min="0" max="100000">
                                ...
                                <select name="location_id" id="location_id" class="form-control">
                                    ...
                                    @if (isset($locations))
                                        @foreach ($locations as $location)
                                            <option value="{{ $location->id }}" @if ($location->id == $subscription->location_id) selected @endif>{{ $location->name }}</option>
                                        @endforeach
                                    @endif
                            </select>
                            @error('location_id')
                        ...
                        <div class="col-md-6">
                            <label for="new_sign_up_allowed"
                                ...
                                <select name="new_sign_up_allowed" id="new_sign_up_allowed" class="form-control">
                                    <option value="1" @if ($subscription->new_sign_up_allowed == '1') selected @endif>True</option>
                                    <option value="0" @if ($subscription->new_sign_up_allowed == '0') selected @endif>False</option>
                                </select>
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea type="text" class="form-control radius-8 @error('description') is-invalid @enderror" name="description" id="description"
                                placeholder="Description" maxlength="200">{{ $subscription->description ?? '' }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
