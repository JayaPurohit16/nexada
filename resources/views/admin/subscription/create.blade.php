...
<div class="dashboard-main-body">
    ...
    <div class="card h-100 p-0 radius-12">
        <div class="card-body p-24">
            <form action="{{ route('admin.subscription.store') }}" method="POST" id="subscriptionForm"
                ...
                <div class="row gy-4">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control radius-8 @error('name') is-invalid @enderror" name="name"
                            id="name" placeholder="Name" maxlength="100">
                        @error('name')
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea type="text" class="form-control radius-8 @error('description') is-invalid @enderror"
                            name="description" id="description" placeholder="Description" maxlength="200"></textarea>
                        @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
