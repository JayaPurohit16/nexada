        ...
        <div class="col-auto">
            <div class="d-flex flex-wrap align-items-center gap-3">
               ...
               <div class="dropdown">
                    ...
                    <a href="{{url('chatify',isset(Auth::user()->id) ? Auth::user()->id : '')}}"   class=" has-indicator w-40-px h-40-px bg-neutral-200 rounded-circle d-flex justify-content-center align-items-center"><iconify-icon icon="mage:email" class="text-primary-light text-xl"></iconify-icon></a>
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu to-top dropdown-menu-sm">
                        <div
                            class="py-12 px-16 radius-8 bg-primary-50 mb-16 d-flex align-items-center justify-content-between gap-2">
                            <div>
                                <h6 class="text-lg text-primary-light fw-semibold mb-2">@if((Auth::user())) {{Auth::user()->fullName}} @endif</h6>
                                <span class="text-secondary-light fw-medium text-sm">@if((Auth::user())) {{Auth::user()->getRoleNames()->first()}} @endif</span>
                            </div>
